...
<form action="" id="registration-form" class="form-reg" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleInputLogin2" value="<?php  $_POST['login'];?>"
    ...
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="exampleInputPassword1"
                name="pass_confirmation" placeholder="Пароль"
               data-validation="length strength" data-validation-length="min6"
               data-validation-error-msg="Короткий пароль, должно быть не меньше 6 симлов"
